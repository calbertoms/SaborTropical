        ...
        buttonSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!verificador) {
                    ...
                    try {
                        ...
                        Toast.makeText(ClientesCadActivity.this,"Erro: " + e.getMessage(),Toast.LENGTH_LONG).show();
            ...
            private boolean testarCampoVazio() {
                ...
                if(TextUtils.isEmpty(nome.getText().toString())) {
                    Toast.makeText(ClientesCadActivity.this, "Campo Nome esta vazio.", Toast.LENGTH_SHORT).show();
                    return true;
                }

                if(TextUtils.isEmpty(sobreNome.getText().toString())) {
                    Toast.makeText(ClientesCadActivity.this, "Campo Sobrenome esta vazio.", Toast.LENGTH_SHORT).show();
                    return true;
                }

                if(TextUtils.isEmpty(dataNascimento.getText().toString())) {
                    Toast.makeText(ClientesCadActivity.this, "Campo Data de Nascimento esta vazio.", Toast.LENGTH_SHORT).show();
                    return true;
                }

                if(TextUtils.isEmpty(nomePai.getText().toString())) {
                    Toast.makeText(ClientesCadActivity.this, "Campo nome do Pai esta vazio.", Toast.LENGTH_SHORT).show();
                    return true;
                }

                if(TextUtils.isEmpty(nomeMae.getText().toString())) {
                    Toast.makeText(ClientesCadActivity.this, "Campo nome da Mãe esta vazio.", Toast.LENGTH_SHORT).show();
                    return true;
                }

                if(TextUtils.isEmpty(cpf.getText().toString())) {
                    Toast.makeText(ClientesCadActivity.this, "Campo cpf esta vazio.", Toast.LENGTH_SHORT).show();
                    return true;
                }

                if(TextUtils.isEmpty(identidade.getText().toString())) {
                    Toast.makeText(ClientesCadActivity.this, "Campo Identidade esta vazio.", Toast.LENGTH_SHORT).show();
                    return true;
                }
